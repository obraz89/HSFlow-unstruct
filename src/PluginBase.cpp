...
// Lookup table implemented as map<key, value-index-in-data-storage>
template<typename K, typename T>
class OrderedMap<K, T>::Lookup : public std::map<K, size_t> {
	// nothing to add to the standard map
};
//-----------------------------------------------------------------------------

template<typename K, typename T>
OrderedMap<K, T>::OrderedMap() : lookup_{ new Lookup() }
{
	;
}

template<typename K, typename T>
OrderedMap<K, T>::OrderedMap(const OrderedMap<K, T> & that)
...
template<typename K, typename T>
OrderedMap<K, T>::~OrderedMap() = default;
//-----------------------------------------------------------------------------

template<typename K, typename T>
bool OrderedMap<K, T>::insert(const Value & key_val)
{
...
template<typename K, typename T>
bool OrderedMap<K, T>::emplace(const K & key, const T & val)
{
	if (has(key))
		return false;
...
template<typename K, typename T>
T& OrderedMap<K, T>::at(const K & key)
{
	return data_[lookup_->at(key)].second;
}

template<typename K, typename T>
const T& OrderedMap<K, T>::at(const K & key) const
{
	return data_[lookup_->at(key)].second;
}
//-----------------------------------------------------------------------------
...
template<typename K, typename T>
bool OrderedMap<K, T>::has(const K & k) const
{
